...
class AzureAIFoundryConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle Azure AI Foundry TTS setup flow."""
    ...
    async def async_step_user(self, user_input=None, errors=None):
        ...
        if user_input is not None:
            ...
            deployment_id = user_input.get(CONF_DEPLOYMENT_ID, "").strip()
            ...
            return self.async_create_entry(
                title="Azure AI Foundry TTS", data=data, options=options
            )
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Required(CONF_DEPLOYMENT_ID): str,
    ...
    def async_get_options_flow(config_entry):
        ...
        return AzureAIFoundryOptionsFlowHandler(config_entry)


class AzureAIFoundryOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        data_schema = vol.Schema(
            {
                vol.Required(
                    CONF_ENDPOINT, default=existing.get(CONF_ENDPOINT, DEFAULT_ENDPOINT)
                ): str,
                vol.Required(
                    CONF_DEPLOYMENT_ID, default=existing.get(CONF_DEPLOYMENT_ID, "")
                ): str,
                vol.Optional(
                    CONF_VOICE, default=existing.get(CONF_VOICE, DEFAULT_VOICE)
                ): vol.In(AZURE_TTS_VOICES),
                vol.Optional(
